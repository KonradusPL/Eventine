...
class AddGroupTest {
    ...
    val token1 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmdWxsTmFtZSI6IktvbnJhZCBQxJlrYWxhIiwiaWQiOiI1YmNlMzE2ZTM1MGM3ZTAwMTAwMDcyZGUiLCJpYXQiOjE1NDAyNDAzMjAsImV4cCI6MTU0MDg0NTEyMH0.Q7QiWVP8FcXGcDL9HzoCocUSL2f4AvLfSEdnDIEy0Ls"
    ...
    @Test
    fun addGroup() {
        val request = CreateGroupRequest("GrupaTest1", emptyList(),emptyList())
        println(request)
